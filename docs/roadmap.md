...
4. 🟡 **Jalon 4 — Compte + contenus** : livré, **en validation HITL** — espace client (connexion démo, dashboard-hub D-035 avec commande en cours et « Racheter » 1 clic, commandes avec timeline D-016 et retour self-service 3 écrans, « Mes animaux » max 5 H24 aligné sur le gabarit listing D-036, adresses, informations + RGPD self-service), gabarit article complet E-E-A-T (D-037 : auteur, relecture pro, sommaire, ≤ 3 produits marqués sélection — guide harnais rédigé), livraison-retours alimentée par la config unique (D-039/D-040), FAQ, contact écrit (H29), suivi invité, pages légales gabarit (H30), CMP cookies interne 3 boutons égaux (D-041). **La validation clôt la Phase 5** (auth réelle, PSP et données serveur = Phase 6).
