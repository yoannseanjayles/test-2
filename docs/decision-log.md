...
| D-019 | 2026-07-14 | Ordre de conception des pages (Phase 2) : Accueil → Fiche produit → Listing/catégorie → Panier → Checkout → Compte → Guides → Confiance/légal | Ordonné par impact business et par dépendances de composants | 🟡 Proposée |
