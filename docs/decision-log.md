...
| D-027 | 2026-07-14 | Listing : 2 gabarits (page animal = aperçu qui route ; sous-catégorie = listing à facettes) ; filtre « gabarit animal » sur toutes les sous-catégories ; « Charger plus » (24/lot) au lieu du scroll infini | Recherche Baymard ; cohérence avec D-002/D-024 ; SEO et position mémorisée | ✅ Validée (HITL 2.1 Listing) |
| D-028 | 2026-07-14 | Facettes en query-string avec canonique vers la catégorie nue ; H16 : landing pages SEO éditorialisées en post-lancement ; H17 : tri par défaut « Notre sélection » curé manuellement | Évite la prolifération d'URLs (risque n°1 SEO) ; curation = positionnement | ✅ Validée (HITL 2.1 Listing) |
